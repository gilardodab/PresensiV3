                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        @if ($user->level== 1) 
                                                            ...
                                                            <form action="{{ route('jabatan.destroy', $jabatan->position_id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="btn btn-xs btn-danger" title="Hapus"><i class="fa fa-trash-o"></i> Hapus</button>
                                                            </form>
                                                        @else
    ...
    <div class="modal fade" id="modalAdd" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="{{ route('jabatan.store') }}" method="post" class="form add-jabatan">
                    {{ csrf_field() }}
